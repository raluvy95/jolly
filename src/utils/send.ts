import { BigString, CreateMessage, Embed, Message } from "@deps";
...
export function send(bot: JollyBot, channelId: BigString, content: string | CreateMessage | Embed[]): Promise<Message> {
